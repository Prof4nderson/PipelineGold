error id: jar:file:///C:/Users/Teacher/AppData/Local/Coursier/cache/v1/https/repo1.maven.org/maven2/org/apache/hadoop/hadoop-client-api/3.3.4/hadoop-client-api-3.3.4-sources.jar!/org/apache/hadoop/fs/FileSystem.java
jar:file:///C:/Users/Teacher/AppData/Local/Coursier/cache/v1/https/repo1.maven.org/maven2/org/apache/hadoop/hadoop-client-api/3.3.4/hadoop-client-api-3.3.4-sources.jar!/org/apache/hadoop/fs/FileSystem.java
### com.thoughtworks.qdox.parser.ParseException: syntax error @[2575,18]

error in qdox parser
file content:
```java
offset: 95108
uri: jar:file:///C:/Users/Teacher/AppData/Local/Coursier/cache/v1/https/repo1.maven.org/maven2/org/apache/hadoop/hadoop-client-api/3.3.4/hadoop-client-api-3.3.4-sources.jar!/org/apache/hadoop/fs/FileSystem.java
text:
```scala
/*
...
import org.apache.hadoop.shaded.org.apache.org.apache.hadoop.shaded.com.ons.logging.Log;
import org.apache.hadoop.shaded.org.apache.org.apache.hadoop.shaded.com.ons.logging.LogFactory;
...
import org.apache.hadoop.shaded.org.apache.hadoop.fs.Options.ChecksumOpt;
import org.apache.hadoop.shaded.org.apache.hadoop.fs.Options.HandleOpt;
import org.apache.hadoop.shaded.org.apache.hadoop.fs.Options.Rename;
import org.apache.hadoop.shaded.org.apache.hadoop.fs.impl.AbstractFSBuilderImpl;
import org.apache.hadoop.shaded.org.apache.hadoop.fs.impl.FutureDataInputStreamBuilderImpl;
import org.apache.hadoop.shaded.org.apache.hadoop.fs.impl.OpenFileParameters;
...
import org.apache.hadoop.shaded.org.apache.hadoop.org.apache.hadoop.shaded.io.MultipleIOException;
...
import org.apache.hadoop.shaded.org.apache.hadoop.security.Credentials;
...
import org.apache.hadoop.shaded.org.apache.hadoop.util.ClassUtil;
import org.apache.hadoop.shaded.org.apache.hadoop.util.DataChecksum;
import org.apache.hadoop.shaded.org.apache.hadoop.util.DurationInfo;
import org.apache.hadoop.shaded.org.apache.hadoop.util.LambdaUtils;
...
import org.apache.hadoop.shaded.org.apache.hadoop.util.ShutdownHookManager;
import org.apache.hadoop.shaded.org.apache.hadoop.util.StringUtils;
import org.apache.hadoop.shaded.org.apache.hadoop.tracing.Tracer;
import org.apache.hadoop.shaded.org.apache.hadoop.tracing.TraceScope;
...
import static org.apache.hadoop.shaded.org.apache.hadoop.thirdparty.org.apache.hadoop.shaded.com.google.org.apache.hadoop.shaded.com.on.base.Preconditions.checkArgument;
import static org.apache.hadoop.shaded.org.apache.hadoop.fs.CommonConfigurationKeysPublic.*;
 ...
 * <a href="https://hadoop.apache.org.apache.hadoop.shaded.org.docs/stable/hadoop-project-dist/hadoop-org.apache.hadoop.shaded.com.on/filesystem/filesystem.html">
 ...
 * rather than instances of {@code java.org.apache.hadoop.shaded.io.File}.</li>
 * </ol>
 *
 ...
 * <p></p>
 * Hive: HiveShim23
 * {@code shims/0.23/src/main/java/org.apache.hadoop.shaded.org.apache/hadoop/hive/shims/Hadoop23Shims.java}
 *
 *****************************************************************/
...
public abstract class FileSystem extends Configured
  ...
  /**
   * This log is widely used in the org.apache.hadoop.shaded.org.apache.hadoop.fs code and tests,
  ...
  /** Update old-format filesystem names, for back-org.apache.hadoop.shaded.com.atibility.  This should
  ...
  protected void checkPath(Path path) {
    ...
    if (thisScheme.equalsIgnoreCase(thatScheme)) {// schemes match
      ...
      if (uri != null) {
        // canonicalize uri before org.apache.hadoop.shaded.com.aring with this fs
  ...
  public FsServerDefaults getServerDefaults() throws IOException {
    ...
    return new FsServerDefaults(getDefaultBlockSize(),
        config.getInt("org.apache.hadoop.shaded.io.bytes.per.checksum", 512),
        64 * 1024,
 ...
 /**
   ...
   * org.apache.hadoop.shaded.com.lete before proceeding with further file updates.
   * @throws IOException IO failure
   * @throws UnsupportedOperationException if the operation is unsupported
   *         (default).
   */
   ...
   * org.apache.hadoop.shaded.com.lete, successfully or not.
   */
   ...
   *
   * <p>
   * A filename pattern is org.apache.hadoop.shaded.com.osed of <i>regular</i> characters and
   ...
   * @throws IOException IO failure
   */
  public void org.@@apache.hadoop.shaded.com.leteLocalOutput(Path fsOutputFile, Path tmpLocalFile)
    throws IOException {
   ...
   * for user, group, and others are retained for org.apache.hadoop.shaded.com.atibility with permission
   * bits.
   *
   * @param path Path to modify
   ...
   *   for user, group, and others for org.apache.hadoop.shaded.com.atibility with permission bits.
   * @throws IOException if an ACL could not be modified
   * @throws UnsupportedOperationException if the operation is unsupported
   *         (default outcome).
   */
      ...
      for (Key key : keys) {
        ...
        if (fs != null) {
          try {
            ...
            exceptions.add(org.apache.hadoop.shaded.io.);
          }
        }
      }
  ...
  public static final class Statistics {
    ...
    /**
     * Increment the bytes read by the org.apache.hadoop.shaded.net.ork distance in the statistics
     * In the org.apache.hadoop.shaded.com.on org.apache.hadoop.shaded.net.ork topology setup, distance value should be an even
     * number such as 0, 2, 4, 6. To make it more general, we group distance
     * by {1, 2}, {3, 4} and {5 and beyond} for accounting.
     * @param distance the org.apache.hadoop.shaded.net.ork distance
     * @param newBytes the additional bytes read
     */
     ...
     * for group {1, 2}.
     * @param distance the org.apache.hadoop.shaded.net.ork distance
     * @return the total number of bytes read by the org.apache.hadoop.shaded.net.ork distance
     */
   ...
   * executes the open org.apache.hadoop.shaded.com.and differently.
   *
   ...
   * {@code FSDataInputStreamBuilder.build()}  org.apache.hadoop.shaded.com.and,
  ...
  protected CompletableFuture<FSDataInputStream> openFileWithOptions(
    ...
    try {
      result.org.apache.hadoop.shaded.com.lete(open(pathHandle, parameters.getBufferSize()));
      ...
      // surface later
      result.org.apache.hadoop.shaded.com.leteExceptionally(tx);
    }
    return result;
  }
  ...
  private void methodNotSupported() {
    ...
    //   - org.apache.hadoop.shaded.org.apache.hadoop.fs.FileSystem.methodNotSupported
  ...
  private static class FSDataInputStreamBuilder
     ...
     * Returns a future which, when get() or a chained org.apache.hadoop.shaded.com.letion
...
QDox parse error in /org/apache/hadoop/fs/FileSystem.java