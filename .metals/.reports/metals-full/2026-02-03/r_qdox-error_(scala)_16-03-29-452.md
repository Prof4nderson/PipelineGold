error id: jar:file:///C:/Users/Teacher/AppData/Local/Coursier/cache/v1/https/repo1.maven.org/maven2/org/apache/hadoop/hadoop-client-api/3.3.4/hadoop-client-api-3.3.4-sources.jar!/org/apache/hadoop/mapreduce/lib/output/FileOutputCommitter.java
jar:file:///C:/Users/Teacher/AppData/Local/Coursier/cache/v1/https/repo1.maven.org/maven2/org/apache/hadoop/hadoop-client-api/3.3.4/hadoop-client-api-3.3.4-sources.jar!/org/apache/hadoop/mapreduce/lib/output/FileOutputCommitter.java
### com.thoughtworks.qdox.parser.ParseException: syntax error @[369,18]

error in qdox parser
file content:
```java
offset: 15439
uri: jar:file:///C:/Users/Teacher/AppData/Local/Coursier/cache/v1/https/repo1.maven.org/maven2/org/apache/hadoop/hadoop-client-api/3.3.4/hadoop-client-api-3.3.4-sources.jar!/org/apache/hadoop/mapreduce/lib/output/FileOutputCommitter.java
text:
```scala
/**
...
import org.apache.hadoop.shaded.org.apache.hadoop.mapreduce.OutputCommitter;
...
import org.apache.hadoop.shaded.org.apache.hadoop.util.DurationInfo;
...
/** An {@link OutputCommitter} that org.apache.hadoop.shaded.com.its files specified 
...
public class FileOutputCommitter extends PathOutputCommitter {
   ...
   * org.apache.hadoop.shaded.com.itted yet.
   */
  public static final String PENDING_DIR_NAME = "_temporary";
  /**
   * Temporary directory name 
   *
   * The static variable to be org.apache.hadoop.shaded.com.atible with M/R 1.x
   */
  @Deprecated
  ...
  // Number of attempts when failure happens in org.apache.hadoop.shaded.com.it job
  ...
  // org.apache.hadoop.shaded.com.itJob will recursively delete the entire job temporary directory.
  ...
  /**
   * Create a file output org.apache.hadoop.shaded.com.itter
   * @param outputPath the job's output path, or null if you want the output
   * org.apache.hadoop.shaded.com.itter to act as a noop.
   ...
   * could also be considered the org.apache.hadoop.shaded.com.itted application attempt path.
   */
  @Override
   ...
   * that task is org.apache.hadoop.shaded.com.itted.
   * 
  ...
  /**
   * Compute the path where the output of a org.apache.hadoop.shaded.com.itted task is stored until
   * the entire job is org.apache.hadoop.shaded.com.itted.
   * @param context the context of the task attempt
   * @return the path where the output of a org.apache.hadoop.shaded.com.itted task is stored until
   * the entire job is org.apache.hadoop.shaded.com.itted.
   */
  ...
  /**
   * Compute the path where the output of a org.apache.hadoop.shaded.com.itted task is stored until the
   * entire job is org.apache.hadoop.shaded.com.itted for a specific application attempt.
   * @param appAttemptId the id of the application attempt to use
   * @param context the context of any task.
   * @return the path where the output of a org.apache.hadoop.shaded.com.itted task is stored.
   */
  ...
  /**
   * Get a list of all paths where output from org.apache.hadoop.shaded.com.itted tasks are stored.
  ...
  /**
   * The job has org.apache.hadoop.shaded.com.leted, so do works in org.apache.hadoop.shaded.com.itJobInternal().
   * Could retry on failure if using algorithm 2.
   * @param context the job's context
   */
  public void org.@@apache.hadoop.shaded.com.itJob(JobContext context) throws IOException {
    ...
    while (jobCommitNotFinished) {
      try {
        org.apache.hadoop.shaded.com.itJobInternal(context);
        jobCommitNotFinished = false;
      } catch (Exception e) {
        if (++attempt >= maxAttemptsOnFailure) {
          throw e;
        } else {
          LOG.warn("Exception get thrown in job org.apache.hadoop.shaded.com.it, retry (" + attempt +
              ") time.", e);
        }
      }
    }
  ...
  /**
   * The job has org.apache.hadoop.shaded.com.leted, so do following org.apache.hadoop.shaded.com.it job, include:
   * Move all org.apache.hadoop.shaded.com.itted tasks to the final output dir (algorithm 1 only).
   * Delete the temporary directory, including all of the work directories.
   * Create a _SUCCESS file to make it as successful.
   * @param context the job's context
   */
  @VisibleForTesting
  protected void org.apache.hadoop.shaded.com.itJobInternal(JobContext context) throws IOException {
    if (hasOutputPath()) {
      ...
      if (skipCleanup) {
        LOG.info("Skip cleanup the _temporary folders under job's output " +
            "directory in org.apache.hadoop.shaded.com.itJob.");
      } else {
        ...
        try {
          ...
          if (ignoreCleanupFailures) {
            ...
            // org.apache.hadoop.shaded.com.itJob could be success even when cleanup get failure.
            LOG.error("Error in cleanup job, manually cleanup is needed.", e);
          } else {
            // throw back exception to fail org.apache.hadoop.shaded.com.itJob.
            throw e;
          }
        }
      }
      ...
      if (context.getConfiguration().getBoolean(
        ...
        // If job org.apache.hadoop.shaded.com.it is repeatable and previous/another AM could write
      ...
      LOG.warn("Output Path is null in org.apache.hadoop.shaded.com.itJob()");
    }
  }
   ...
   * @param from the path data is org.apache.hadoop.shaded.com.ng from.
  ...
  public void cleanupJob(JobContext context) throws IOException {
    if (hasOutputPath()) {
      ...
      // if job allow repeatable org.apache.hadoop.shaded.com.it and pendingJobAttemptsPath could be
   ...
   */
  @Override
  public void org.apache.hadoop.shaded.com.itTask(TaskAttemptContext context) 
  throws IOException {
    org.apache.hadoop.shaded.com.itTask(context, null);
  }

  @Private
  public void org.apache.hadoop.shaded.com.itTask(TaskAttemptContext context, Path taskAttemptPath) 
      throws IOException {
    ...
    if (hasOutputPath()) {
      ...
      if (taskAttemptDirStatus != null) {
        if (algorithmVersion == 1) {
          Path org.apache.hadoop.shaded.com.ittedTaskPath = getCommittedTaskPath(context);
          if (fs.exists(org.apache.hadoop.shaded.com.ittedTaskPath)) {
             if (!fs.delete(org.apache.hadoop.shaded.com.ittedTaskPath, true)) {
               throw new IOException("Could not delete " + org.apache.hadoop.shaded.com.ittedTaskPath);
             }
          }
          if (!fs.rename(taskAttemptPath, org.apache.hadoop.shaded.com.ittedTaskPath)) {
            throw new IOException("Could not rename " + taskAttemptPath + " to "
                + org.apache.hadoop.shaded.com.ittedTaskPath);
          }
      ...
      LOG.warn("Output Path is null in org.apache.hadoop.shaded.com.itTask()");
    }
  }
    ...
    if(hasOutputPath()) {
      ...
      if (algorithmVersion == 1) {
        if (fs.exists(previousCommittedTaskPath)) {
          Path org.apache.hadoop.shaded.com.ittedTaskPath = getCommittedTaskPath(context);
          if (!fs.delete(org.apache.hadoop.shaded.com.ittedTaskPath, true) &&
              fs.exists(org.apache.hadoop.shaded.com.ittedTaskPath)) {
            throw new IOException("Could not delete " + org.apache.hadoop.shaded.com.ittedTaskPath);
          }
          //Rename can fail if the parent directory does not yet exist.
          Path org.apache.hadoop.shaded.com.ittedParent = org.apache.hadoop.shaded.com.ittedTaskPath.getParent();
          fs.mkdirs(org.apache.hadoop.shaded.com.ittedParent);
          if (!fs.rename(previousCommittedTaskPath, org.apache.hadoop.shaded.com.ittedTaskPath)) {
            throw new IOException("Could not rename " + previousCommittedTaskPath +
                " to " + org.apache.hadoop.shaded.com.ittedTaskPath);
          }
        } else {
            LOG.warn(attemptId+" had no output to recover.");
        }
      } else {
        // essentially a no-op, but for backwards org.apache.hadoop.shaded.com.atibility
        // after upgrade to the new fileOutputCommitter,
        // check if there are any output left in org.apache.hadoop.shaded.com.ittedTaskPath
        try {
...
com.thoughtworks.qdox.parser.impl.Parser.yyerror(Parser.java:2025)
	...
	scala.meta.internal.mtags.SymbolIndexBucket.$anonfun$query0$4(SymbolIndexBucket.scala:224)
	scala.meta.internal.mtags.SymbolIndexBucket.$anonfun$query0$4$adapted(SymbolIndexBucket.scala:224)
	scala.collection.immutable.List.foreach(List.scala:323)
	scala.meta.internal.mtags.SymbolIndexBucket.$anonfun$query0$3(SymbolIndexBucket.scala:224)
	scala.meta.internal.mtags.SymbolIndexBucket.$anonfun$query0$3$adapted(SymbolIndexBucket.scala:224)
	scala.Option.foreach(Option.scala:437)
	scala.meta.internal.mtags.SymbolIndexBucket.query0(SymbolIndexBucket.scala:224)
	...
	scala.meta.internal.metals.StacktraceAnalyzer.findLocationForSymbol$1(StacktraceAnalyzer.scala:82)
	scala.meta.internal.metals.StacktraceAnalyzer.$anonfun$fileLocationFromLine$2(StacktraceAnalyzer.scala:90)
	...
	scala.meta.internal.metals.StacktraceAnalyzer.$anonfun$fileLocationFromLine$1(StacktraceAnalyzer.scala:90)
	scala.Option.flatMap(Option.scala:283)
	scala.meta.internal.metals.StacktraceAnalyzer.fileLocationFromLine(StacktraceAnalyzer.scala:88)
	scala.meta.internal.metals.debug.DebugProxy.addStackTraceFileLocation(DebugProxy.scala:298)
	scala.meta.internal.metals.debug.DebugProxy.$anonfun$handleServerMessage$1(DebugProxy.scala:274)
...
QDox parse error in /org/apache/hadoop/mapreduce/lib/output/FileOutputCommitter.java