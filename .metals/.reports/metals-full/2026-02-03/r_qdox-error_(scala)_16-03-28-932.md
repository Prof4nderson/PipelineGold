error id: jar:file:///C:/Users/Teacher/AppData/Local/Coursier/cache/v1/https/repo1.maven.org/maven2/org/apache/hadoop/hadoop-client-api/3.3.4/hadoop-client-api-3.3.4-sources.jar!/org/apache/hadoop/fs/FileUtil.java
jar:file:///C:/Users/Teacher/AppData/Local/Coursier/cache/v1/https/repo1.maven.org/maven2/org/apache/hadoop/hadoop-client-api/3.3.4/hadoop-client-api-3.3.4-sources.jar!/org/apache/hadoop/fs/FileUtil.java
### com.thoughtworks.qdox.parser.ParseException: syntax error @[716,42]

error in qdox parser
file content:
```java
offset: 25825
uri: jar:file:///C:/Users/Teacher/AppData/Local/Coursier/cache/v1/https/repo1.maven.org/maven2/org/apache/hadoop/hadoop-client-api/3.3.4/hadoop-client-api-3.3.4-sources.jar!/org/apache/hadoop/fs/FileUtil.java
text:
```scala
/**
...
import java.org.apache.hadoop.shaded.io.BufferedReader;
import java.org.apache.hadoop.shaded.io.BufferedWriter;
...
import java.org.apache.hadoop.shaded.io.InputStreamReader;
import java.org.apache.hadoop.shaded.io.OutputStream;
import java.org.apache.hadoop.shaded.io.OutputStreamWriter;
...
import org.apache.hadoop.shaded.org.apache.org.apache.hadoop.shaded.com.ons.collections.map.CaseInsensitiveMap;
import org.apache.hadoop.shaded.org.apache.org.apache.hadoop.shaded.com.ons.org.apache.hadoop.shaded.com.ress.archivers.tar.TarArchiveEntry;
import org.apache.hadoop.shaded.org.apache.org.apache.hadoop.shaded.com.ons.org.apache.hadoop.shaded.com.ress.archivers.tar.TarArchiveInputStream;
...
import org.apache.hadoop.shaded.org.apache.hadoop.util.Shell.ShellCommandExecutor;
...
public class FileUtil {
   ...
   * "src\winutils\org.apache.hadoop.shaded.com.on.h"
   * */
  public static final int SYMLINK_NO_PRIVILEGE = 2;

  /**
   * Buffer size for copy the content of org.apache.hadoop.shaded.com.ressed file to new file.
   */
  ...
  public static long getDU(File dir) {
    ...
    if (!dir.isDirectory()) {
      ...
      if (allFiles != null) {
        for (File f : allFiles) {
          if (!org.apache.hadoop.shaded.org.apache.org.apache.hadoop.shaded.com.ons.org.apache.hadoop.shaded.io.FileUtils.isSymlink(f)) {
            size += getDU(f);
          }
        }
      }
  ...
  /**
   * Run a org.apache.hadoop.shaded.com.and and send the contents of an input stream to it.
   * @param inputStream Input stream to forward to the shell org.apache.hadoop.shaded.com.and
   * @param org.apache.hadoop.shaded.com.and shell org.apache.hadoop.shaded.com.and to run
   * @throws IOException read or write failed
   * @throws InterruptedException org.apache.hadoop.shaded.com.and interrupted
   * @throws ExecutionException task submit failed
   */
  private static void runCommandOnStream(@@
      InputStream inputStream, String org.apache.hadoop.shaded.com.and)
      throws IOException, InterruptedException, ExecutionException {
    ExecutorService executor = null;
    ProcessBuilder builder = new ProcessBuilder();
    builder.org.apache.hadoop.shaded.com.and(
        Shell.WINDOWS ? "cmd" : "bash",
        Shell.WINDOWS ? "/c" : "-c",
        org.apache.hadoop.shaded.com.and);
    Process process = builder.start();
    int exitCode;
    try {
      // Consume stdout and stderr, to avoid blocking the org.apache.hadoop.shaded.com.and
      ...
      Future output = executor.submit(() -> {
        try {
          ...
          if (LOG.isDebugEnabled()) {
            ...
            org.apache.hadoop.shaded.org.apache.org.apache.hadoop.shaded.com.ons.org.apache.hadoop.shaded.io.IOUtils.copy(
      ...
      // Pass the input stream to the org.apache.hadoop.shaded.com.and to process
      try {
        org.apache.hadoop.shaded.org.apache.org.apache.hadoop.shaded.com.ons.org.apache.hadoop.shaded.io.IOUtils.copy(
    ...
    if (exitCode != 0) {
      throw new IOException(
          String.format(
              "Error executing org.apache.hadoop.shaded.com.and. %s " +
                  "Process exited with exit code %d.",
              org.apache.hadoop.shaded.com.and, exitCode));
    }
  }
  ...
  private static void unTarUsingTar(File inFile, File untarDir,
    ...
    if (exitcode != 0) {
      throw new IOException("Error untarring file " + inFile +
          ...
          + " from org.apache.hadoop.shaded.com.and " + untarCommand);
    }
  }
  ...
  private static void unpackEntries(TarArchiveInputStream tis,
    ...
    org.apache.hadoop.shaded.org.apache.org.apache.hadoop.shaded.com.ons.org.apache.hadoop.shaded.io.FileUtils.copyToFile(tis, outputFile);
  }

  /**
   * Gets the canonical path for the given path.
   *
   * @param path      The path for which the canonical path needs to be org.apache.hadoop.shaded.com.uted.
   ...
   * @deprecated Use {@link org.apache.hadoop.shaded.org.apache.hadoop.fs.HardLink}
   */
  @Deprecated
  public static class HardLink extends org.apache.hadoop.shaded.org.apache.hadoop.fs.HardLink {
    // This is a stub to assist with coordinated change between
    // COMMON and HDFS projects.  It will be removed after the
    // corresponding change is org.apache.hadoop.shaded.com.itted to HDFS.
  }
  ...
  public static int symLink(String target, String linkname) throws IOException{
    ...
    try {
      if (Shell.WINDOWS &&
        ...
        // creation. To ensure this we run the shell org.apache.hadoop.shaded.com.and in the directory
        // of the link.
        //
   ...
   * @return the exit code from the org.apache.hadoop.shaded.com.and
   * @throws IOException
   ...
   * @see java.org.apache.hadoop.shaded.io.File#createTempFile(String, String, File)
   * @see java.org.apache.hadoop.shaded.io.File#deleteOnExit()
   */
  ...
  /**
   * A wrapper for {@link File#listFiles()}. This java.org.apache.hadoop.shaded.io.API returns null
  ...
  /**
   * A wrapper for {@link File#list()}. This java.org.apache.hadoop.shaded.io.API returns null
   * when a dir is not a directory or for any I/O error. Instead of having
   ...
   *
   * Some platforms may have an upper limit on org.apache.hadoop.shaded.com.and line length.  For example,
   * the maximum org.apache.hadoop.shaded.com.and line length on Windows is 8191 characters, but the
  ...
  public static boolean org.apache.hadoop.shaded.com.areFs(FileSystem srcFs, FileSystem destFs) {
    ...
    if ((srcHost!=null) && (dstHost!=null)) {
      ...
      try {
        ...
        if (LOG.isDebugEnabled()) {
          LOG.debug("Could not org.apache.hadoop.shaded.com.are file-systems. Unknown host: ", ue);
        }
        return false;
      }
      if (!srcHost.equals(dstHost)) {
...
QDox parse error in /org/apache/hadoop/fs/FileUtil.java